...
from content.image import Image, IMAGES_EXT, IMAGES_START_YEAR, IMAGES_END_YEAR, IMAGES_DIRS
from content.font import getFonts
from content.slugs import *

class Site:

    def __init__(self, name, id, url, imageRootPath, assetsPath, templatesPath):
        self.name = name
        self.id = id
        self.url = url
    ...
    def initializePages(self):
        ...
        for page in (
                ...
                Page('Proforma-Pro', slug=TP_PROFORMA, templateName='family'),
